...
class DirectRLEnv(gym.Env):
    ...
    def step(self, action: torch.Tensor) -> VecEnvStepReturn:
        ...
        self.hard_constraints_buf = self._get_hard_constraints()
        ...
        return self.obs_buf, self.reward_buf, self.hard_constraints_buf, self.reset_terminated, self.reset_time_outs, self.extras
    ...
    def _get_hard_constraints(self) -> torch.Tensor:
        ...
        Returns:
            The rewards for the environment. Shape is (num_envs,).
        """
        raise NotImplementedError(f"Please implement the '_get_hard_constraints' method for {self.__class__.__name__}.")
