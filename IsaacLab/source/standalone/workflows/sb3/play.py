...
def main():
    ...
    agent = "PPO" if args_cli.agent is None else args_cli.agent
    entry_point = "sb3_ppo_cfg_entry_point" if agent == "PPO" else "sb3_sac_cfg_entry_point"
    ...
    agent = PPO if agent == "PPO" else SAC
    print(f"Playing with agent: {agent}")
